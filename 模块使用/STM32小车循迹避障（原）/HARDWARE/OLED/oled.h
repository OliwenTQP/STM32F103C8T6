...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOA,GPIO_Pin_8)
#define OLED_SCLK_Set() GPIO_SetBits(GPIOA,GPIO_Pin_8)//SCL
...
void num2char(char *str, float number, u8 g, u8 l);  //用于将浮点数转换成字符，再用oled显示
